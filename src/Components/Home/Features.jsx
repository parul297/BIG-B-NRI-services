  ...
  return (
    <section style={{ background: '#ffffff' }} className="py-16">
      <div className="max-w-7xl mx-auto px-4">
        <h2 style={{ color: '#071020' }} className="text-3xl font-bold mb-2">Our Services</h2>
        <p style={{ color: '#3a3a3a' }} className="mb-10">Explore our comprehensive range of NRI services</p>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <ServiceFeatureCard
            title="Civil Renovators"
...
function ServiceFeatureCard({ title, description, image, highlight }) {
  const getIcon = (imageName) => {
    switch(imageName) {
      case 'property':
        return (
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M19 21V5C19 3.89543 18.1046 3 17 3H7C5.89543 3 5 3.89543 5 5V21M19 21H5M19 21H21M5 21H3M9 7H10M9 11H10M14 7H15M14 11H15M10 21V17C10 16.4477 10.4477 16 11 16H13C13.5523 16 14 16.4477 14 17V21" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        )
      case 'civil':
        return (
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M7 14H9M15 10H17" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        )
      case 'birth':
        return (
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M9 12L11 14L15 10M12 3L13.2 5.4L15.9 5.8L13.9 7.8L14.4 10.5L12 9.3L9.6 10.5L10.1 7.8L8.1 5.8L10.8 5.4L12 3ZM5 19H19C20.1046 19 21 18.1046 21 17V7C21 5.89543 20.1046 5 19 5H5C3.89543 5 3 5.89543 3 7V17C3 18.1046 3.89543 19 5 19Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        )
      case 'online':
        return (
      ...
      case 'health':
        return (
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M14 16H10M12 14V18M8 8H16M8 12H16M19 3H5C3.89543 3 3 3.89543 3 5V19C3 20.1046 3.89543 21 5 21H19C20.1046 21 21 20.1046 21 19V5C21 3.89543 20.1046 3 19 3Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        )
      default:
        return (
  ...
  return (
    <div className={`feature-card group cursor-pointer rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl relative ${highlight ? 'feature-highlight' : ''}`} style={{ background: '#ffffff' }}>
      ...
      <div className="p-6 relative">
        <h3 style={{ color: '#071020' }} className="text-xl font-bold mb-3 group-hover:text-amber-700 transition-colors duration-300">{title}</h3>
        <p style={{ color: '#3a3a3a' }} className="text-sm mb-4 leading-relaxed">{description}</p>
        ...
        <div className="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M5 12H19M19 12L12 5M19 12L12 19" stroke="#d4af37" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
      </div>
