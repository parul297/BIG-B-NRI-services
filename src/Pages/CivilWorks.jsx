...
//     { image: construction, title: 'Construction', description: 'Quality building projects' },
//     { image: renovation, title: 'Renovation', description: 'Transform your space' },
//     { image: upgradation, title: 'Upgradation', description: 'Modern improvements' },
//     { image: farmHouse, title: 'Farmhouses', description: 'Rural development' }
//   ];
...
//           <h2 className="text-3xl md:text-4xl font-bold text-center mb-12" style={{color: '#071020'}}>
...
//                     </svg>
//                   </div>
//                   <p className="text-sm font-semibold" style={{color: '#5a4a1a'}}>Construction</p>
//                 </div>
//                 <div className="p-4 rounded-xl" style={{background: 'rgba(212, 175, 55, 0.1)'}}>
//                   <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2"
//                        style={{background: 'rgba(212, 175, 55, 0.2)'}}>
...
//                     </svg>
//                   </div>
//                   <p className="text-sm font-semibold" style={{color: '#5a4a1a'}}>Renovation</p>
//                 </div>
//                 <div className="p-4 rounded-xl" style={{background: 'rgba(212, 175, 55, 0.1)'}}>
//                   <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2"
//                        style={{background: 'rgba(212, 175, 55, 0.2)'}}>
...
//                     </svg>
//                   </div>
//                   <p className="text-sm font-semibold" style={{color: '#5a4a1a'}}>Maintenance</p>
//                 </div>
//                 <div className="p-4 rounded-xl" style={{background: 'rgba(212, 175, 55, 0.1)'}}>
//                   <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2"
//                        style={{background: 'rgba(212, 175, 55, 0.2)'}}>
...
//                     </svg>
//                   </div>
//                   <p className="text-sm font-semibold" style={{color: '#5a4a1a'}}>Farmhouses</p>
//                 </div>
//               </div> */}
